...
train_data_dir = 'mlops_project/download_classify/17_flowers/17_flowers/train/'
validation_data_dir = 'mlops_project/download_classify/17_flowers/17_flowers/validation'
